                  ...
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                        <div class="row">
                           <div class="col-sm-12">
                              ...
                              <div class="buynow_bt"><a href="#">Clean Now</a></div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="carousel-item">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">CUCIIN <br>Clean Your Shirt</h1>
                              <div class="buynow_bt"><a href="#">Clean Now</div>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <div class="tshirt_img"><img src="{{ asset('mockup/images/hoodie.png')}}"></div>
                                 <div class="btn_main">
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <div class="tshirt_img"><img src="{{ asset('mockup/images/jaket.png')}}"></div>
                                 <div class="btn_main">
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="row">
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <div class="electronic_img"><img src="{{ asset('mockup/images/selimut.png')}}"></div>
                                 <div class="btn_main">
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <div class="electronic_img"><img src="{{ asset('mockup/images/bed_cover.png')}}"></div>
                                 <div class="btn_main">
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <div class="electronic_img"><img src="{{ asset('mockup/images/boneka.png')}}"></div>
                                 <div class="btn_main">
                                 </div>
                              </div>
                           </div>
